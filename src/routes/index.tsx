...
function HubPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      {/* Banner de aviso de mudança de URL */}
      <div className="w-full bg-[#8a1a1a] text-white text-center px-4 py-2.5 text-xs md:text-sm font-medium">
        ⚠️ Atenção: este link vai mudar em breve para{" "}
        <span className="font-bold underline">tailor-hub.lovable.app</span>
        . Guarde o novo endereço!
      </div>
